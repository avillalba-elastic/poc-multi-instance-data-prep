...
aws stepfunctions create-state-machine --name poc-multi-instance-data-prep-pyspark-sagemaker-processing --definition file://pipelines/pyspark_process.json --role-arn arn:aws:iam::879381254630:role/service-role/StepFunctions-mvp_mlops_platform_data_preprocessi-role-bn368ux1z --profile ml
